...
inline std::string* SudokuRequest::release_checkerboard() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = checkerboard_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (checkerboard_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
